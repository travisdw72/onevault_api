-- =====================================================================================
-- Script: dbCreation_22_backup_recovery_infrastructure.sql
-- Description: Backup & Recovery Infrastructure Implementation - Phase 1
-- Version: 1.0
-- Date: 2024-12-19
...
GRANT USAGE ON SCHEMA backup_mgmt TO authenticated_users;  -- ✅ CORRECTED: plural exists
...
DO $$
BEGIN
    RAISE NOTICE '✅ Backup & Recovery Infrastructure Schema - Phase 1 completed successfully';
    ...
    RAISE NOTICE '   - authenticated_users (corrected from authenticated_user)';
    RAISE NOTICE '   - dv_admin, dv_reader, dv_loader (Data Vault roles)';
    RAISE NOTICE '   - app_user (application role)';
