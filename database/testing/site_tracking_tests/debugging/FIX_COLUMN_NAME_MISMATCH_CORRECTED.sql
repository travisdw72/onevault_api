-- ============================================================================
-- FIX COLUMN NAME MISMATCH - CORRECTED VERSION
-- Site Tracking System Business Layer Fix
-- ============================================================================
-- Purpose: Fix column name mismatch AND use proper business key formats
-- Issue: Must use correct prefixes and get_or_create functions
-- ============================================================================
